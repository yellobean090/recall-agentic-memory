...
export const toolDefinitions = [
    {
        ...
        description: "Semantically search past incidents by symptom/description similarity using CockroachDB's distributed vector index. Use this before proposing a root cause, to check if this incident has been seen before.",
        input_schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Write a new incident (or update an existing one) to persistent memory, including its embedding for future semantic recall.",
        input_schema: {
            type: "object",
            properties: {
                title: { type: "string" },
    ...
    },
    {
        ...
        description: "Inspect the agent's own CockroachDB memory store via the CockroachDB MCP server — total incidents stored, how many unresolved, and vector index status. Use when asked about memory health or before a long investigation to confirm memory is available.",
...
export async function searchSimilarIncidents(query, limit = 3) {
